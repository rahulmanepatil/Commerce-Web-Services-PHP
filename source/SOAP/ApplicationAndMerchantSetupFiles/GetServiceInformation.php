...
if ($_serviceId == null)
{
	...
	if ($response->BankcardServices->BankcardService != null)
	{
	...
	if ($response->ElectronicCheckingServices->ElectronicCheckingService != null)
	{
	...
	if ($response->StoredValueServices->StoredValueService != null)
	{
