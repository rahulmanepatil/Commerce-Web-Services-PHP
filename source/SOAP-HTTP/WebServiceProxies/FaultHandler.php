...
function buildException($e){
	...
	if($exceptionName == "ExceptionDetail" && $e->faultcode == "a:DeserializationFailed")
	{
		$exceptionName = "CWSDeserializationFault";
		$message = $e->detail['ExceptionDetail']['InnerException']['Message'];
	}	
